...
public class Politica  extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView.addItemDecoration(new Politica.GridSpacingItemDecoration(1, dpToPx(0), true));
    ...
    public void getPostPolitica(){

        helpers = new Helpers();

        Log.d(TAG,"Politica");

        newsRequest = new News(getContext(), constants.URL_SERVICES + "topico/politica", new News.NewsListener() {
