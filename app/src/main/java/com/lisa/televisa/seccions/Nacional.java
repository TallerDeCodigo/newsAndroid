...
public class Nacional extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView.addItemDecoration(new Nacional.GridSpacingItemDecoration(1, dpToPx(0), true));
    ...
    public void getNacional(){

        helpers = new Helpers();



        newsRequest = new News(getContext(), constants.URL_SERVICES + "region/nacional", new News.NewsListener() {
