...
public class Vida extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView.addItemDecoration(new Vida.GridSpacingItemDecoration(1, dpToPx(0), true));
    ...
    public void getOpinion(){
        ...
        newsRequest = new News(getContext(), constants.URL_SERVICES + "topico/vida-y-estilo", new News.NewsListener() {
