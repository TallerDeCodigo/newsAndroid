...
public class Deportes extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView.addItemDecoration(new Deportes.GridSpacingItemDecoration(1, dpToPx(0), true));
    ...
    public void getDeportes(){

        helpers = new Helpers();

        newsRequest = new News(getContext(), constants.URL_SERVICES + "topico/deportes", new News.NewsListener() {
