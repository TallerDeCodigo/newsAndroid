...
public class Opinion extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView.addItemDecoration(new Opinion.GridSpacingItemDecoration(1, dpToPx(0), true));
    ...
    public void getOpinion(){
        ...
        newsRequest = new News(getContext(), constants.URL_SERVICES + "topico/internacional", new News.NewsListener() {
