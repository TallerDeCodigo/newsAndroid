...
public class Cultura extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView.addItemDecoration(new Cultura.GridSpacingItemDecoration(1, dpToPx(0), true));
    ...
    public void getCultura(){

        helpers = new Helpers();



        newsRequest = new News(getContext(), constants.URL_SERVICES + "topico/cultura", new News.NewsListener() {
