...
public class Economia extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView.addItemDecoration(new Economia.GridSpacingItemDecoration(1, dpToPx(0), true));
    ...
    public void getPostEconomia(){

        helpers = new Helpers();

        Log.d(TAG,"economia");

        newsRequest = new News(getContext(), constants.URL_SERVICES + "topico/economia", new News.NewsListener() {
