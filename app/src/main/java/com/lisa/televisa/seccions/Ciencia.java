...
public class Ciencia extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView.addItemDecoration(new Ciencia.GridSpacingItemDecoration(1, dpToPx(0), true));
    ...
    public void getCiencia(){

        helpers = new Helpers();



        newsRequest = new News(getContext(), constants.URL_SERVICES + "topico/ciencia-y-tecnologia", new News.NewsListener() {
